...
You can install Xcode deriectly from the App store (it's free).
Xcode is a very large program, so its worth checking if you already have it installed. If not, open terminal and run:
