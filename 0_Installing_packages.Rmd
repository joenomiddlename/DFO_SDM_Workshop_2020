...
For Mac, installing Xcode is an easy way to achieve this. 
...
Our methodology highly depends on the INLA package. This **testing** version of this package must be installed directly from the [www.r-inla.org](https://www.r-inla.org) website. To do so, you can run the following in R:
