$(document).ready(function() {
  ...
  $chunks.each(function () {
    ...
    // add button to show extra code chunks
    if ( $(this).hasClass('e') ) {
      $('pre.e', this).prepend("<div class=\"showopt\">Show Extra Code</div><br style=\"line-height:22px;\"/>");
      $('pre.e', this).children('code').attr('class', 'folded');
    }
