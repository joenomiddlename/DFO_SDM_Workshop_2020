...
Note that all the workshop scripts and files can be found [here](https://github.com/joenomiddlename/DFO_SDM_Workshop_2020) and [here](https://ubcca-my.sharepoint.com/:u:/g/personal/joewatto_student_ubc_ca/Ea8lRO_ESL5CgfFSWqOT0LUBzskEWVVA_v6N2B2RZhr67w?email=m.auger-methe%40oceans.ubc.ca&e=TvsrM1) respectively.

First lets load all the required R packages
