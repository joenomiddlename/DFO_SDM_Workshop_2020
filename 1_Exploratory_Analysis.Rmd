...
**JOE: here is where to talk about the log(1-bathy) in detail and specify that this is done for the Poisson point process, but also for all of the models explored afterward. Then save the log_bathy objects so that they can be loaded in the next tutorials and skip that step. **
