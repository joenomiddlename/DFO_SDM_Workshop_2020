...
**JOE: the two definitions are not the most intuitive. Can you dumb them down? Or at least emphasize the differences. Something like lambda_obs is how many sightings (or the probablity of a sighting?) we expect given the amount of effort in that area? And something like $\lambda_{true}(s)$ is the probability of a sighting at point s if it is searched. I'm sure some of this is not correct, but hopefully you get the idea.**
