...
## Identifying a good detection function
...
To explore which detection function that should be used with the survey data, we now plot the histogram of measured distances from the plane (i.e. the observed distances of sightings from the trackline).
