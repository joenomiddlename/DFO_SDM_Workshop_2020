...
If the data are in lat/lon format then the `gmap()` function can add a layer from Google Maps or OpenStreetMap to the plots. Let's plot the survey sightings in blue, the survey tracklines in black, the whale watch sightings in purple, the whale watch ports in red. We'll add a terrain map to the background too.
