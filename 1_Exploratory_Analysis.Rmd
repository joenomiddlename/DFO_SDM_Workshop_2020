...
We will create multiple plots with days on the x-axis and km on the y-axis. The first plot restricted to only consider temporal differences of less than 85 days. 
...
We now subset the data into a training and test set. We choose the training set to contain all the sightings from 2007-2009. For the test data, we choose **all** the sightings from 2011. See [Additional tips](#Ad3) for an explanation of why the 2011 whale-watching data cannot be added to the training dataset.
...
### Potential repeated whale-watch and survey sightings in 2011 {#Ad3}
