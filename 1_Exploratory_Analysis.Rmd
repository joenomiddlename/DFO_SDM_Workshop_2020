...
First, we plot the empirical density of the slope at the sightings locations in black and that throughout the domain (study area) in red. 
...
ggplot(data=data.frame(Slope_obs = Slope_obs),
  ...
  scale_color_manual(name = "Slope", values = c('Sightings' = 'black', 'Domain' = 'red'))
