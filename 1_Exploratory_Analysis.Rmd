...
**JOE: this section needs work. I know you now changed to inlabru and that's great, but I had more or less removed lost of details from this section before so they would addressed above to  help discuss things in small manageable packages (you can still see this from my old comment above), but you have re-put a lot of the details back. I must be honest this is a bit discouraging. Your work is great and the inlabru change here is also a great improvement on using ppm, and I know you worked days and days on this. But I spend hours (evening hours) doing these changes to help make the material more understandable for ecologists, and I feel some comments were more less ignored and reverted back (or not merged?). It's been a bit of a pattern lately, so it's harder for me to take it. Having lots of details is particularly weird now, because you don't go into the details of inlabru and preface many things with "we are going to talk about this again or later". I think you missed opportunity to present some of the ideas of inlabru syntax and I'm not sure I understand what's the main message here. What do you want them to get out of this? Please read this critically, and think about whether you have said this before, whether it's needed now, whether it can be skipped. **
