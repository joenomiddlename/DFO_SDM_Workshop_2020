...
**JOE: add reference given by Shelley**
...
**JOE: add one line about why you need a training and test dataset. And specify whether the testing and the training is used in the exploratory analysis tutorial/activity. Or whether you are just using the training to explore and teh testing will be used another day/tutorial.**
